...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<a href="#" class="btn btn-light mr-1"><i
				class="fas fa-user-circle fa"></i>Admin</a>
				<a href="logout"
				class="btn btn-light "><i class="fas fa-sign-in-alt"></i>Log Out</a> 
				</c:if>
				<c:if test="${userobj.role eq 'user' }">
		<a href="#" class="btn btn-light mr-1" data-toggle="modal" data-target="#exampleModal"><i
				class="fas fa-user-circle fa"></i> ${ userobj.name }
				</a> 
				<a href="logout"
				class="btn btn-light "><i class="fas fa-sign-in-alt"></i>Log Out</a>
				</c:if>
		...
		<a href="login.jsp" class="btn btn-light mr-1"><i
				...
				class="btn btn-light "><i class="fas fa-user-circle fa"></i>SignUp</a>
		</c:if>
